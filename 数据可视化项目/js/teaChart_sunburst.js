    ...
    class TeaSunburstChart {
        ...
        transformData() {
            const root = {
                ...
                value: 0,
                children: [],
                itemStyle: { color: 'transparent' } // 中心节点透明
            };
            ...
            this.processExcelData().forEach(row => {
                ...
                const titles = row.titles.split(/[、\n]/g)  // 简化分割逻辑
                    .map(t => t.replace(/《|》/g, '').trim()) // 去除书名号后trim
                    .filter(t => t);
            ...
            console.log('Data Structure:', JSON.stringify(root, null, 2));
        }
        ...
        //             dynasty: currentDynasty,
        //             titles: row.titles,
        //             author: (row.author || "未知作者").split(/，|、/)[0].trim(),
        ...
        initChart() {
            ...
            const fullOption = {
                ...
                series: [{
                    ...
                    data: [{
                        ...this.transformData(),
                        children: this.transformData().children.map(child => ({
                            ...child,
                            collapsed: false
                        }))
                    }]
            ...
            this.chart.setOption(fullOption, true); // 使用true清空旧配置
            this.initTooltip();
